                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header text-center" style="background-color: #0ac198;color: white">
                                     ...
                                     <form id="login" method="post" action= "{{ URL::to('/success') }}">
                                {{csrf_field()}}
...
<!--                                             <div class="md-form">
                ...
                <table class="table table-bordered" style="alignment: center">
                    ...
                    <tr >
                            ...
                            <td>{{$s->address}}</td>
                            <td >
                              <!--   <a href="{{ URL::to('editsalesman/'.$s->id)}}">Edit</a> || -->
                                <a href="{{  URL::to('addsalesman/'.$s->id)}}" class="btn btn-danger btn-round" >DELETE</a> 
